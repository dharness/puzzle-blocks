...
FTD_IKMoveTo::FTD_IKMoveTo(const FLatentActionInfo& LatentInfo, UCurveFloat* Curve, FVector From, FVector To, USceneComponent* Target) :
...
void FTD_IKMoveTo::UpdateOperation(FLatentResponse& Response)
{
	...
	Target->SetWorldLocation(NextLocation);
}